...
const createReadmeGif = async () => {
   ...
   const readmeContent = await fs.promises.readFile('images/df_from_bigquery.py', 'utf8');
   ...
   const gifPath = await gif.save('df-from-bigquery', path.resolve(__dirname), "lossless");
   return gifPath;
}
